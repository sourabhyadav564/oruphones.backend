...
const attachedListingsModal = require('@/database/modals/global/oru_mitra/attached_mitras_modal');
const scrappedMitrasModal = require('@/database/modals/global/oru_mitra/scrapped_mitras');
