...
app.use(
	'/api/v2/notification',
	require('./routes/v2/notification/notification_save_token_routes')
);
...
app.use(
	'/api/v2/device',
	require('./routes/v2/device/get_external_sell_source')
);
app.use(
	'/api/v2/device',
	require('./routes/v2/device/buyer_verification_routes')
);
...
app.use(
	'/api/v2/device',
	require('./routes/v2/device/complete_best_deal_routes')
);
...
app.use(
	'/api/v2/master',
	require('./routes/v2/master/marketing_name_by_model_routes')
);
