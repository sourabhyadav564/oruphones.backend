...
const getBestDeals = async (location, userUniqueId, make, marketingname) => {
  ...
  try {
    ...
    if (make === "" && marketingname === "") {
    ...
    } else if (make === "" && marketingname !== "") {
      if (location === "India") {
        defaultDataObject = await saveListingModal.find({marketingname: marketingname});
      } else {
        defaultDataObject = await saveListingModal.find({
          listingLocation: location,
      ...
      if (location === "India") {
        defaultDataObject = await saveListingModal.find({make: make});
      } else {
        defaultDataObject = await saveListingModal.find({
          listingLocation: location,
          make: make,
    ...
    // console.log("finalbestdeals", finalBestDeals);
    return otherListings, finalBestDeals;
  } catch (error) {
    console.log(error);
